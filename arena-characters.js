...
'use strict';
var list=[
{id:'tr_seon',name:'혜수',en:'HYESU',role:'여유롭게 판을 지배하는 승부사',quote:'좋은 패보다, 흔들리지 않는 눈빛.',color:'#bd6877',image:'assets/traders/hyesu-hd-v2.png',motion:'assets/traders/motion/hyesu-idle-hd-v2.webp'},
...
// Keep ownership/skill keys stable: tr_seon now shows Hyesu; tr_yuna shows Seon.
list.forEach(function(c){c.motion=c.motion||'assets/traders/motion/'+c.id.slice(3)+'-idle-v6.webp';});
